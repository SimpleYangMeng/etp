<?php /* Smarty version Smarty-3.1.13, created on 2017-01-18 16:09:13
         compiled from "D:\www\etp\trunk\application\modules\default\views\register\step3.tpl" */ ?>
<?php /*%%SmartyHeaderCode:30192587f22a90a63d8-38846636%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '97527b50a3db4c3b020bc63db688182aba09c709' => 
    array (
      0 => 'D:\\www\\etp\\trunk\\application\\modules\\default\\views\\register\\step3.tpl',
      1 => 1484188928,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '30192587f22a90a63d8-38846636',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_587f22a950fe45_31246278',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_587f22a950fe45_31246278')) {function content_587f22a950fe45_31246278($_smarty_tpl) {?><?php if (!is_callable('smarty_block_t')) include 'D:\\www\\etp\\trunk\\libs\\Smarty\\plugins\\block.t.php';
?><style type="text/css">
...
RegTerms<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</div>
        <div class="reg_form_wrap reg_email_ver_content">
        	<form id="registerForm" class="fm-layout" method="post" action="/register/step?current=3_1&visitor_type=<?php echo $_smarty_tpl->tpl_vars['visitor_type']->value;?>
"  onsubmit="return docheck();">
        		<h2 class="tk_title"><?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
etpPsP<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</h2>
				...
				<p class=""> 
					<label class="agree_label cl">
						...
						<span class="agree_text leftloat"><?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Agree<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
				...
				<p style="text-align: center;"> 
					<input type="submit" class="button" style="padding: 8px 12px;" value="<?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
NextStep<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
" />
				</p>
...
NoAgree<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
');
			return false;
		}
		return true;
