...
class Service_Application
{
     ...
     */
    public static function getByFieldLock($value, $field = 'application_id', $colums = "*")
    {
        $model = self::getModelInstance();
        return $model->getByFieldLock($value, $field, $colums);
    }
    /**
     * [getForUpdate description]
     *
     * @param  [type] $application_id [description]
     *
     * @return [type]                 [description]
     */
    public static function getForUpdate($application_id) {
    	$model = self::getModelInstance();
    	return $model->getForUpdate($application_id);
    }
