...
class Table_OrderLog
{
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "order_log_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "order_log_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'order_log_id', $colums = "*")
    {
