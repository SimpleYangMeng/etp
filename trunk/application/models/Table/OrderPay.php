<?php
class Table_OrderPay
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_OrderPay();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "order_pay_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "order_pay_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'order_pay_id', $colums = "*")
    {
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "")
    {
        ...
        if(isset($condition["pay_time_start"]) && $condition["pay_time_start"] != ""){
            $select->where("pay_time >= ?",$condition["pay_time_start"]);
        }
        if(isset($condition["pay_time_end"]) && $condition["pay_time_end"] != ""){
            $select->where("pay_time <= ?",$condition["pay_time_end"]);
        }
        /*CONDITION_END*/
        if ('count(*)' == $type) {
