<?php
class Table_SellerBalanceLog
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_SellerBalanceLog();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "seller_balance_log_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "seller_balance_log_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'seller_balance_log_id', $colums = "*")
    {
