<?php
class Table_Settlement
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_Settlement();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "settlement_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "settlement_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'settlement_id', $colums = "*")
    {
