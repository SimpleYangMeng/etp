...
<{if $language == 'en_US'}>
.m_colContainer .col-r .bottom .tabBtnGroup .tabBtn { padding: 0 10px; }
<{/if}>
</style>
        ...
        <form id="searchForm" method="post" action="" onsubmit="return false">
            ...
            <div class="cl">
                <div class="form_item f_left clearfix">
                    <span class="tit f_left"><{t}>charge_type<{/t}><{t}>colon<{/t}></span>
                    <div class="dl f_left">
                        <select name="condition[charge_type]" id="" class="selBox" style="min-width: 80px;max-width: 245px;">
                ...
                <div class="form_item clearfix f_left margin_left20">
                    <span class="tit f_left"><{t}>RechargeNo<{/t}><{t}>colon<{/t}></span>
                    <div class="dl f_left">
            ...
            <div class="cl">
                <div class="form_item  f_left clearfix">
                    <span class="tit f_left"><{t}>rechargeTime<{/t}><{t}>colon<{/t}></span>
                    <div class="dl f_left">
                ...
                <table class="table table-striped table-hover table-responsive" cellpadding="0" cellspacing="0" border="0">
                    <thead>
                        <tr>
                            ...
                            <th width="100"><{t}>charge_type<{/t}></th>
                            <th width="80"><{t}>status<{/t}></th>
                            <th width="140"><{t}>FromBankCard<{/t}></th>
...
<script type="text/javascript">
    ...
    ETP.getListData = function (json) {
        ...
        $.each(json.data, function (key, val) {
            ...
            html += "<td>" + val.E8 + "</td>";
            html += "<td>" + val.E18 + "</td>";
            html += '<td><a href="/buyer/charge/recharge-view?parmId='+val.E0 +'" class="view_link" data-toggle="tooltip" data-placement="right" title="<{t}>chargeView<{/t}>"><span class="glyphicon glyphicon glyphicon-list-alt"></span></a></td>';
            html += "</tr>";
        });
        return html;
    }
