...
<div class="m_mainContainer">
    <div class="min_width">
        <p class="title"><{$visitorText}><{t}>completeData<{/t}></p>
        <div class="form_group">
            <form id="completeForm" action='' onsubmit='return false' class="fm-layout" method="post" data-validator-option="{timely:2, theme:'yellow_right_effect'}">
                ...
                <div class="form_item margin_top25 clearfix">
                    ...
                    <div class="dl">
                        <input type="text" class="input" name="complereData[company_name]" data-rule="<{t}>companyName<{/t}>:required,length[6~120]" data-tip="<{t}>companyNameNotice<{/t}>"/>
                    </div>
                </div>
                <div class="form_item margin_top25 clearfix">
                ...
                <div class="form_item margin_top50 clearfix">
                    <p class="tit">&nbsp;</p>
                    <div class="dl">
                        <input type="submit" value="<{t}>submit<{/t}>" style="padding: 2px 12px;" id="registersub" />
                    </div>
                </div>
