            ...
            <form id="setPasswordForm" method="post" action="" onsubmit="return false" data-validator-option="{timely:2, theme:'yellow_right_effect'}">
                <div class="form_group margin_top25">
                    <div class="form_item clearfix">
                        <p class="tit" style="width: 150px"><{t}>payPwd<{/t}> <span class="blue_00a0e9">*</span></p>
                        <div class="dl">
                ...
                <div class="form_group margin_top25">
                    <div class="form_item clearfix">
                        <p class="tit" style="width: 150px"><{t}>Confirm<{/t}><{t}>password<{/t}> <span class="blue_00a0e9">*</span></p>
                        <div class="dl">
    ...
    $('#setPasswordForm').validator({
        valid: function() {
            $.ajax({
                ...
                url: '/portal/purchaser/do-set-paypwd',
                success: function(json) {
                    var html = '';
                    if (json.state == '1') {
                        //alertTip(json.message, 3);
                        var gotoURL = 'window.location.href="/portal/purchaser/set-paypwd-success"';
