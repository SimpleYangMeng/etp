...
<script type="text/javascript">
    ...
    ETP.getListData = function (json) {
        ...
        $.each(json.data, function (key, val) {
            ...
            html += '<td><a href="/portal/purchaser/recharge-view?parmId='+val.buyer_recharge_id+'" class="view_link" data-toggle="tooltip" data-placement="right" title="<{t}>cashView<{/t}>"><span class="glyphicon glyphicon glyphicon-list-alt"></span></a></td>';
            html += "</tr>";
        });
        return html;
    }
