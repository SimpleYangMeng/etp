    ...
    <div class="form_group clearfix">
        <form id="setPasswordForm" method="post" action="" onsubmit="return false" data-validator-option="{timely:2, theme:'yellow_right_effect'}">
            <div class="form_item margin_top45 clearfix">
                <span class="tit width240 f_left" style="width: 150px"><{t}>oldPassword<{/t}>：<em class="blue_00a0e9">*</em></span>
                <div class="dl f_left clearfix">
                    <input type="password" name="payPwd" class="input" data-rule="<{t}>oldPassword<{/t}>:required;length(6~16)" data-tip="<{t}>oldPassword<{/t}>"/>
                </div>
            </div>
            <div class="form_item margin_top45 clearfix">
                <span class="tit width240 f_left" style="width: 150px"><{t}>newPassword<{/t}>：<em class="blue_00a0e9">*</em></span>
                <div class="dl f_left clearfix">
                    <input type="password" name="newPwd" class="input" data-rule="<{t}>newPassword<{/t}>:required;length(6~16)" data-tip="<{t}>Gtsix<{/t}>"/>
                </div>
            </div>
            <div class="form_item margin_top45 clearfix">
                <span class="tit width240 f_left" style="width: 150px"><{t}>Confirm<{/t}><{t}>newPassword<{/t}>：<em class="blue_00a0e9">*</em></span>
                <div class="dl f_left clearfix">
                    <input type="password" name="reNewPwd" class="input" data-rule="<{t}>Confirm<{/t}><{t}>newPassword<{/t}>:required;length(6~16):match[newPwd]" data-tip="<{t}>rePassword<{/t}>"/>
                </div>
            </div>
...
<div class="bottom" id="setSuccess" style="display: none;">
    ...
    <p class="text_align_c margin_top35">
        <a href="javascript:;" class="blue_btn blue_btn_h_32 f14"><{t}>goHome<{/t}></a>
    </p>
</div>
...
$(function() {
    ...
    $('#setPasswordForm').validator({
        //验证原始密码
        fields: {
            'payPwd': "<{t}>oldPassword<{/t}>:required;remote[/portal/account/check-pwd, payPwd]"
        },
        valid: function() {
            ...
            $.ajax({
                ...
                url: '/portal/account/update-pay-pwd',
