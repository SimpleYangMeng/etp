            ...
            <table class="table-list">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <span><{$buerRow.seller_code}></span>
                            <span class="text-muted">|</span>
                            <span class="text-muted"><{t}>Certified<{/t}></span>
                        </td>
                        <td class="last">
                            <span><a href="javascript:;" class="blue-link" seed="last-blueLink" smartracker="on"><{t}>view<{/t}></a></span>
                        </td>
                    </tr>
                    <tr>
                        <th><{t}>Email<{/t}></th>
                        ...
                        <td class="last">
                            <span><a href="/portal/account/edit-account-info" class="blue-link" seed="last-blueLink" smartracker="on"><{t}>modify<{/t}></a></span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="last"><span><a href="/portal/account/edit-account-info" class="blue-link" seed="last-blueLink" smartracker="on"><{t}>modify<{/t}></a></span></td>
                    </tr>
                    <tr>
                        <th><{t}>address<{/t}></th>
                    ...
                    <tr>
                        ...
                        <td class="last"><span><a href="/portal/account/modify-login-pwd" class="blue-link" seed="last-blueLink" smartracker="on"><{t}>modify<{/t}></a></span></td>
                    </tr>
                    <!--
                    <tr>
                        <th>
                        ...
                        <td class="last"><span><a href="/portal/account/payment-password" class="blue-link" seed="last-blueLink" smartracker="on"><{t}>modify<{/t}></a></span></td>
                    </tr>
                    -->
                </tbody>
            </table>
...
<script type="text/javascript">
    ETP.indexAction = 'get-purchaser-log';
    ETP.url = '/portal/supplier/';
