...
<script type="text/javascript">
    ETP.indexAction = 'supplier-trade-order';
    ETP.url = '/portal/record/';
    ETP.getListData = function (json) {
        ...
        $.each(json.data, function (key, val) {
            ...
            html += "<td><{t}>changeBefore<{/t}>:" +val.sb_value+'<br /><{t}>changeAfter<{/t}>:'+ val.sb_value_change + "</td>";
            html += "<td><{t}>changeBefore<{/t}>:" +val.settling_value+'<br /><{t}>changeAfter<{/t}>:'+ val.settling_value_change + "</td>";
            html += "<td><{t}>changeBefore<{/t}>:" +val.settling_hold_value+'<br /><{t}>changeAfter<{/t}>:'+ val.settling_hold_value_change + "</td>";
            html += "<td><{t}>changeBefore<{/t}>:" +val.internal_value+'<br /><{t}>changeAfter<{/t}>:'+ val.internal_value_change + "</td>";
            html += "<td><{t}>changeBefore<{/t}>:" +val.foreign_value+'<br /><{t}>changeAfter<{/t}>:'+ val.foreign_value_change + "</td>";
