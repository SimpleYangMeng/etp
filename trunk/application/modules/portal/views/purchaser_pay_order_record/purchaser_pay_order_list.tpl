...
<script type="text/javascript">
    ...
    ETP.url = '/portal/purchaser-pay-order-record/';
    ETP.getListData = function (json) {
        ...
        $.each(json.data, function (key, val) {
            ...
            html += '<td><a href="/portal/purchaser-pay-order-record/pay-order-detail?parmId='+val.order_pay_id+'" class="view_link" data-toggle="tooltip" data-placement="right" title="<{t}>detail<{/t}>"><span class="glyphicon glyphicon glyphicon-list-alt"></span></a></td>';
            html += "</tr>";
        });
        return html;
    }
