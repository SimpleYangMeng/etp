            ...
            <table class="table-list">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="last"><span><a href="/seller/account/modify-login-pwd" class="blue-link" seed="last-blueLink" smartracker="on"><{t}>modify<{/t}></a></span></td>
                    </tr>
                    <!--
                    <tr>
                        <th>
                        ...
                        <td class="last"><span><a href="/seller/account/payment-password" class="blue-link" seed="last-blueLink" smartracker="on"><{t}>modify<{/t}></a></span></td>
                    </tr>
                    -->
                </tbody>
            </table>
