...
<div class="top clearfix">
    ...
    <p class="f15 margin_top20" style="padding-left: 60px"><{t}>overseasAmount<{/t}>：&nbsp;&nbsp;<span class="f16 red_e83d2c balance"><{$cBalance}>&nbsp;&nbsp;<{if !empty($currency)}><{if $language=='zh_CN'}><{$currency['currency_name']}><{else}><{$currency['currency_name_en']}><{/if}><{/if}></span></p>
    <p class="margin_top5 gray_919191" style="padding-left: 60px"><{t}>foreignWithdrawTip1<{/t}></p>
    <p class="margin_top5 gray_919191" style="padding-left: 60px"><{t}>foreignWithdrawTip2<{/t}></p>
    <p class="margin_top5 gray_919191" style="padding-left: 60px"><{t}>foreignWithdrawTip3<{/t}></p>
</div>
<div class="bottom">
            ...
            <div class="form_item clearfix">
                ...
                <div class="dl f_left clearfix">
                    ...
                    <select name="data[country_id]" id="" class="selBox" style="min-width: 80px;max-width: 245px;" data-rule="<{t}>bankLocation<{/t}>:required;">
                        ...
                        <option value="<{$item['country_id']}>" <{if $item['country_code'] == 'US'}>selected="selected"<{/if}>><{if $language=='zh_CN'}><{$item['country_name']}><{else}><{$item['country_name_en']}><{/if}></option>
                        <{/foreach}>
                    </select>
                </div>
            </div>
