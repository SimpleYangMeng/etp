...
<div class="m_mainContainer">
        <div class="form_group" <{if $language == 'en_US' }>style="padding:20px 0 50px 30px;"<{/if}>>
            <form id="completeForm" action='' onsubmit='return false' class="fm-layout" method="post" data-validator-option="{timely:2, theme:'yellow_right_effect'}">
                ...
                <div class="form_item margin_top25 clearfix">
                    <p class="tit <{if $language=='zh_CN'}>tit_120_zh_CN<{else}>tit_225_en_US<{/if}>">
                        <{t}>address<{/t}><{t}>colon<{/t}>
                        <span class="blue_00a0e9">*</span>
                    </p>
                    <div class="dl">
                        <input type="text" class="input" name="address" value="<{$companyInfo['register_address']}>" data-rule="<{t}>address<{/t}>:required" data-tip="<{t}>addressNotice<{/t}>" />
                    </div>
                </div>
                <div class="form_item margin_top25 clearfix">
                    <p class="tit <{if $language=='zh_CN'}>tit_120_zh_CN<{else}>tit_225_en_US<{/if}>">
                        <{t}>contactName<{/t}><{t}>colon<{/t}>
                        <span class="blue_00a0e9">*</span>
                    </p>
                    <div class="dl">
                ...
                <div class="form_item margin_top25 clearfix">
                    <p class="tit <{if $language=='zh_CN'}>tit_120_zh_CN<{else}>tit_225_en_US<{/if}>">
                        <{t}>contactEmail<{/t}><{t}>colon<{/t}>
                        <span class="blue_00a0e9">*</span>
                    </p>
                    <div class="dl">
                        <!--<input type="text" class="input" name="email" readonly="readonly" value="" data-rule="required" data-tip="<{t}>contactEmailNotice<{/t}>" />-->
                        <{$companyInfo['email']}>
                    </div>
                </div>
                <div class="form_item margin_top25 clearfix">
                    <p class="tit <{if $language=='zh_CN'}>tit_120_zh_CN<{else}>tit_225_en_US<{/if}>">
                        <{t}>currency<{/t}><{t}>colon<{/t}>
                        <span class="blue_00a0e9">*</span>
                    </p>
                    <div class="dl">
