    ...
    <div class="<{if $language=='zh_CN'}>form_group<{else}>form_group_en_US<{/if}> clearfix">
        <form id="setPasswordForm" method="post" action="" onsubmit="return false" data-validator-option="{timely:2, theme:'yellow_right_effect'}">
            ...
            <div class="form_item margin_top25 clearfix">
                <span class="tit <{if $language=='zh_CN'}>tit_130_zh_CN<{else}>tit_230_en_US<{/if}> f_left">&nbsp;</span>
...
<div id="success-div" style="display:none;margin-top:15%;text-align:center;font-size:15px">
    <i class="sucIcon"></i> <{t}>setPayPwdSuccess<{/t}>
    <p class="margin_top20"><a href="/seller/portal" class="blue_btn blue_btn_h_32 f14"><{t}>goHome<{/t}></a></p>
</div>
...
$(function() {
    ...
    $('#setPasswordForm').validator({
        //验证原始密码
        fields: {
            'payPwd': "<{t}>oldPassword<{/t}>:required;remote[/seller/account/check-pwd, payPwd]"
        },
        valid: function() {
            ...
            $.ajax({
                ...
                url: '/seller/account/update-pay-pwd',
