    ...
    <div class="tips_notice">
        <div class="bot">
            ...
            <p class="margin_top25">
                <a href="/seller/portal" class="blue_btn blue_btn_h_32 margin_left190"><{t}>login_in<{/t}><{t}>operationAdmin<{/t}></a>
            </p>
            <p class="margin_top20">
                <{if $language == 'zh_CN'}>
                <a href="/seller/portal" class="blue_link f14 margin_left150">
                    系统将在 
                    <span id="second_span">
                    5s 
                    </span>
                ...
                <{else}>
                <a href="/seller/portal" class="blue_link f14 <{if $language == 'en_US'}>margin_left100<{else}>margin_left150<{/if}>">
